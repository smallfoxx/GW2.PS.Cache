# Welcome to the PowerShell Module for caching the Guild Wars 2 API locally: GW2.PS.Cache
...
However, this is still in pre-production, so if you want to use this early, you can download the contents of the [Module](https://github.com/smallfoxx/GW2.PS.Cache/tree/main/Module) folder to your local system and run:
...
This project is published under the MIT License.  Full details available in the [LICENSE](https://github.com/smallfoxx/GW2.PS.Cache/blob/main/LICENSE) file of the repository.
